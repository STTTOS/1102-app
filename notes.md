...
### MessageBox
**Attention:MessageBox的按需引入不同于其他的组件, 它没有install方法**
![img](./img/messageBox1.png)

### dialog
**相比于MessageBox 用于需要更多自定义通知的场景**
```html
        <el-dialog
            title="修改信息"  标题
            :center="true"   表头 表尾居中
            :visible="dialogVisible" 是否显示dialog
            :show-close="false"  是否显示关闭按钮
            :append-to-body="true" 是否将元素append to body
            width="30%"
        >
        </el-dialog>
```
